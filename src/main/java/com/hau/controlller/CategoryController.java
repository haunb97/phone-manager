...
public class CategoryController {
    ...
    public ModelAndView saveCategory(@ModelAttribute("category") Category category) {
        ...
        ModelAndView modelAndView = new ModelAndView("/category/create");
        modelAndView.addObject("category", new Category());
        modelAndView.addObject("message", "da them loai dien thoai thanh cong");
        return modelAndView;
    }
    ...
    public ModelAndView updateCategory(@ModelAttribute("supplier") Category category){
        categoryService.save(category);
        ModelAndView modelAndView = new ModelAndView("/category/edit");
        modelAndView.addObject("category", category);
        modelAndView.addObject("message", "Cap nhat loai dien thoai thanh cong");
        return modelAndView;
    }
